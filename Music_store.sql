--Q1: Who is the senior most employee based on job titlr?
...
--Q7: Let's invite the artists who have written tha most rock music in our dataset. Write a query 
...
SUM(il.unit_price*il.quantity) AS amount_apent
FROM invoice i
